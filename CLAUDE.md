...
- Lenis (smooth scroll, via `src/hooks/useLenis.js`)
...
- `LoadScreen.jsx` — loading screen shown before content, dismissed via `onComplete` callback
- `ScrollProgress.jsx`, `CursorGlow.jsx`, `Grain.jsx` — ambient effects
- `About.jsx` — exists in src/components but is NOT imported in App.jsx (unused or removed)
